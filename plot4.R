...
with(ElPowCon, plot(DateTime,Global_active_power, type="l", xlab="", ylab="Global Active Power"))
...
with(ElPowCon, plot(DateTime,Voltage, type="l", xlab="datetime", ylab="Energy sub metering"))

with(ElPowCon, plot(DateTime,Global_reactive_power, type="l", xlab="datetime", ylab="Global reactive power"))
